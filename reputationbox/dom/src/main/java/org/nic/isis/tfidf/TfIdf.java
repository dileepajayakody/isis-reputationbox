...
public class TfIdf {
	 ...
	 * 
	 * @param totaltermsinEmail
	 *            : Array of all the words under processing email
	 * @param termToCheck
	 *            : term of which tf is to be calculated.
	 * @return tf(term frequency) of term termToCheck
	 */
	public static double tfCalculator(List<String> totaltermsinEmail,
			String termToCheck) {
	 ...
	 */
	public static double idfCalculator(Collection<List<String>> allEmailTerms,
			String termToCheck) {
		double count = 0;
