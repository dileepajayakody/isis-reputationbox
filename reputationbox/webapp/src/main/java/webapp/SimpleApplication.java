    ...
    protected Module newIsisWicketModule() {
        ...
        final Module simpleOverrides = new AbstractModule() {
            ...
            protected void configure() {
                ...
                bind(String.class).annotatedWith(Names.named("applicationName")).toInstance("Reputation Box");
                ...
                bind(String.class).annotatedWith(Names.named("aboutMessage")).toInstance("Reputation Box Demo");
